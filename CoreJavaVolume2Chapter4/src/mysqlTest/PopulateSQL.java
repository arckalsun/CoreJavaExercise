   ...
   public static void main(String args[]) throws IOException
   {
         ...
         else
         {
        	 for ( int i=0; i < args.length; i++)
        	 {
        		 ...
        		 in = new Scanner(Paths.get(args[i]));
        		 run(in);
        	 }
         }
         
   }
   public static void run(Scanner in) throws IOException
   {
	   try
	   {
	   try (Connection conn = getConnection())
       {
          ...
          while (true)
          {
             ...
             if (line.equalsIgnoreCase("EXIT") || line.equalsIgnoreCase("")) {
            	 System.out.println("输入为空, 退出程序");
            	 return;
             }
